...
require.register("elm/SeatServer.elm", function(exports, require, module) {
...
var _user$project$SeatServer$main = _elm_lang$virtual_dom$Native_VirtualDom.staticProgram(
	_elm_lang$html$Html$text('Hello from Elm!'));

var Elm = {};
Elm['SeatServer'] = Elm['SeatServer'] || {};
if (typeof _user$project$SeatServer$main !== 'undefined') {
    _user$project$SeatServer$main(Elm['SeatServer'], 'SeatServer', undefined);
}
