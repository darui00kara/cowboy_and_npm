...
var _user$project$SeatServer$main = {
	main: _elm_lang$html$Html$text('Hello from Elm')
};

var Elm = {};
Elm['SeatServer'] = Elm['SeatServer'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['SeatServer'], 'SeatServer', typeof _user$project$SeatServer$main === 'undefined' ? null : _user$project$SeatServer$main);
